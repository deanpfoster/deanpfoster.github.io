...
local: 
	...
	-cd ~/public_html_gosset/teaching/linguistics; git pull; git commit -a -m "Make updating to gosset."; git push ;make
...
gosset: 
	...
	-cd ~/public_html/teaching/linguistics; git pull; git commit -a -m "Make updating to gosset."; git push ;make
