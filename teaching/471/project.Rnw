...
\section*{Look at Kaggle.com?}

For an interesting collection of prediction problems, try Kaggle.com.


\section{Proposal}
For the proposal, you need to email us  
\begin{enumerate}
\item who is going to be in your group.  (2 or 3 people.)
\item Title of your project
\item A one paragraph summary of what your project is. (You might
 discuss what you might learn from your analysis and how you might
 analyse your data.)
\item Pointers to where you will get your data (i.e. from the web) or
a description of you you will collect it.
\end{enumerate}
...
slides.  So I will expect you to have a one page handout.  The point is if anyone actually
...
\item[KeyPoint] You will get instant feed back forms from several of
your fellow students.  You want one of your fellow
...
\section{Final paper (two files: .pdf plus .R)}
...
output.  (R code should be in a different file.)  Basically
