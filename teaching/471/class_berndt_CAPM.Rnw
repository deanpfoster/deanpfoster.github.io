...
\section{Admistrivia}
\begin{itemize}
\item Start on next homework.  It walks you through using all the
ideas we have talked about in class so far.
\item No writeups necessary.  Just practice R.
\end{itemize}
...
\begin{itemize}
\item \href{http://gosset.wharton.upenn.edu/~foster/teaching/471/domino_sugar.csv}{domino
sugar}
\item \href{http://gosset.wharton.upenn.edu/~foster/teaching/471/tbills-inflation}{t-bills} 
\end{itemize}
...
#    ##########################################################
     ...
     tbills <- read.csv( "http://gosset.wharton.upenn.edu/~foster/teaching/471/tbills-inflation" );  
