...
The market seems weird.  Let's see a plot of what it really is:

<<fig=TRUE>>=

plot(market ~ time,xlab="time", ylab="raw market",main="monthly returns")
@ 
<<fig=TRUE>>=

plot(market.year ~ time.year,xlab="time", ylab="raw
market",col=color.year,pch=symbol.year,main="yearly returns")
@ 
...
plot(market.year - cpi.year ~ cpi.year,xlab="CPI", ylab="Real Return",col=color.year,pch=symbol.year,main="yearly (contemperanious)")
abline(model$coef)
...
plot(market.5year - cpi.5year ~ cpi.5year,xlab="CPI", ylab="Real Return",col="white",main="5 year (contempornaious)")
...
plot(time, riskfree,main="monthly")
@ 
...
plot(time, cpi.raw,main="monthly CPI")
...
plot(time.year, cpi.year,col=color.year,pch=symbol.year,main="Yearly CPI")
...
plot(time.5year, cpi.5year,col=color.5year,pch=symbol.5year,main="5 year")
