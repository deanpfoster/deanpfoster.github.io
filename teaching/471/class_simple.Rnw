...
ahold of who ever is currently on line sooner.
  \end{itemize}
\item Books
  \begin{itemize}
...
1-58488-425-8, Chapman \& Hall/CRC Press 2005. 
  \item Based on discussion with students last year, only one of these
is recommended.  Which is it?
  \end{itemize}
\item Software R
  \begin{itemize}
  ...
  \item Friday at 1pm, Joshua will give an intro to using R.  (And
our computer person will be there to help load it if you have problems.)
  \end{itemize}
\end{itemize}
...
planet.  I would have recommended him for the genious award--but he
already has one.
...
\item Data analysis: Linear is esiest to look at--so start there.
