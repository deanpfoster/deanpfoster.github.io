...
\item Wave grading and interactions
  \begin{itemize}
\item I've always done it myself in the past
...
\item Software R
  ...
  \item I'll give a short introduction to R after class Monday week.
\item No hard copy this year.
  \end{itemize}
\end{itemize}
