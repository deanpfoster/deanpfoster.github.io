...
in assignmens
  \begin{itemize}
  \item Both Sathya and I get messages sent here.  So that way you get
...
\item Software R
  ...
  \item Friday at noon, Sathya will give an intro to using R.  (And
our computer (Anand) person will be there to help load it if you have problems.)
  \end{itemize}
\end{itemize}
