...
\item Now we want to make a prediction of the next word based on the
 ...
 compressed data (look \href{google/easy_google}{here} for
it.) If you want to read this into R you will find the files
google/easy\_one and google/easy\_two will read in with less trouble.
\footnote{Or you can use Sivan's magic of:
\texttt{
