...
wallstree has gone broke) to help you keep track of your pennies.
Unfortunately, he doesn't really read the problem description very
well and instead think we are compounding.  So he defines $A_t = 1 +
a_t$.  Hence each round $A_t = 1$ or $A_t = 1.01$ depending on whether
A wins nothing or A wins a penny.  He then computes the log growth
rate of this compound series.  Show that $\log \prod A_t \approx \sum
a_t$.
