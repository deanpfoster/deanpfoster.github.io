...
\SweaveOpts{prefix.string=.figures/sample}
...
\subsection*{Calibration isn't easy}


<<nocalib,echo=FALSE,fig=TRUE,include=FALSE>>=
...
@ 
\includegraphics[width=2.5in]{.figures/sample-nocalib}

<<better,echo=FALSE,fig=TRUE,include=FALSE>>=
...
@ 
\includegraphics[width=2.5in]{.figures/sample-better}
