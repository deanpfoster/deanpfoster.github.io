...
\begin{itemize}
\item I'll post homework this weekend.
\end{itemize}
...
\begin{itemize}
\item A sequence is well defined in mathematics
\item Example: My SS\# starts the same way as Lucas numbers sequence
\item See
\href{http://www.research.att.com/~njas/sequences/Seis.html}{OEIS} 
\item But for words not so easy
\end{itemize}
...
\item Common in Economics (learning theory that I've worked on),
information theory (Adi did stuff on this), and also lingustics 
\end{itemize}
...
\end{displaymath}
\item I'll ask you in homework to relate this to the entropy.  (I'll
post this weekend some homework to practice with.)
\end{itemize}
