...
that easier if your cut and paste doesn't work from the pdf.  (You can
also grab it out of the Rwn file.)
...
\section{Final Project (from 2010)}

 For 2012, I'm pushing a paper replication.  But, if anyone picks
doing a final project rather than language log like posts, I'll write
up some multiple turn in times like the following:
\begin{itemize}
\item (Nov 8, 2010) One page description of what you propose to do.
\begin{itemize}
...
\end{itemize}
\item (Nov 15, 2010) References section.  What papers are related to your project?
\begin{itemize}
